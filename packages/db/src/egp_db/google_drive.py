"""Google Drive OAuth and REST helpers shared by API and worker runtimes."""
...
class GoogleDriveClient:
    ...
    def download_file(self, *, access_token: str, file_id: str) -> bytes:
        ...
        try:
            ...
            raise GoogleDriveApiError(
                f"Google Drive download failed: HTTP {exc.code}"
            ) from exc
    ...
    def delete_file(self, *, access_token: str, file_id: str) -> None:
        ...
        try:
            ...
            raise GoogleDriveApiError(
                f"Google Drive delete failed: HTTP {exc.code}"
            ) from exc
